      ...
      <m.div {...reveal()} style={{ textAlign: "center", maxWidth: 560, margin: "0 auto", position: "relative" }}>
        ...
        {sent ? (
          ...
          <form onSubmit={submit} style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
            <label htmlFor="cta-email" style={{ position: "absolute", width: 1, height: 1, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap", border: 0 }}>
              Your email address
            </label>
            <input
              id="cta-email"
...
function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/6281234567890?text=Hi%20Limadata%2C%20I%27d%20like%20to%20learn%20more%20about%20your%20services."
      target="_blank"
